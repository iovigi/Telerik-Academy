namespace Surfaces
{
    ...
    {
        private static PropertyHolder<Material, Surface> materialProperty = new PropertyHolder<Material, Surface>("Material", null, OnMaterialChanged);
        private static PropertyHolder<Material, Surface> backMaterialProperty = new PropertyHolder<Material, Surface>("BackMaterial", null, OnBackMaterialChanged);
        private static PropertyHolder<bool, Surface> visibleProperty = new PropertyHolder<bool, Surface>("Visible", true, OnVisibleChanged);
        ...
        {
            get { return backMaterialProperty; }
            set { backMaterialProperty = value; }
        }

        public static PropertyHolder<bool, Surface> VisibleProperty
        {
            get { return visibleProperty; }
