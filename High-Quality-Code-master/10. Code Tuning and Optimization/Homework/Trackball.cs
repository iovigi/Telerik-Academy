namespace Microsoft._3DTools
{
    ...
    public class Trackball
    {
        ...
        {
            var currentPosition3D = this.ProjectToTrackball(this.EventSource.ActualWidth, this.EventSource.ActualHeight, currentPosition);
        ...
        private void OnMouseDown(object sender, MouseEventArgs e)
        {
            ...
            this.previousPosition3D = this.ProjectToTrackball(this.EventSource.ActualWidth, this.EventSource.ActualHeight, this.previousPosition2D);
        }
