namespace SortComparer
{
    ...
    public static class QuickSortComparer
    {
        public static void RandomCompare(int countOfElementInArray)
        {
            ...
            Console.WriteLine("Quick sort result for random int is:{0}", stopwatch.ElapsedMilliseconds);

            stopwatch.Restart();
            QuickSort<double>.Sort(doubleArray, Comparer<double>.Default);
            stopwatch.Stop();

            Console.WriteLine("Quick sort result for random double is:{0}", stopwatch.ElapsedMilliseconds);

            stopwatch.Restart();
            QuickSort<string>.Sort(stringArray, Comparer<string>.Default);
            stopwatch.Stop();

            Console.WriteLine("Quick sort result for random string is:{0}", stopwatch.ElapsedMilliseconds);
        }
        ...
        public static void SequentialCompare(int countOfElementInArray)
        {
            ...
            Console.WriteLine("Quick sort result for sequential int is:{0}", stopwatch.ElapsedMilliseconds);

            stopwatch.Restart();
            QuickSort<double>.Sort(doubleArray, Comparer<double>.Default);
            stopwatch.Stop();

            Console.WriteLine("Quick sort result for sequential double is:{0}", stopwatch.ElapsedMilliseconds);

            stopwatch.Restart();
            QuickSort<string>.Sort(stringArray, Comparer<string>.Default);
            stopwatch.Stop();

            Console.WriteLine("Quick sort result for sequential string is:{0}", stopwatch.ElapsedMilliseconds);
        }
